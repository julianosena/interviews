...
class CreateBookingUseCaseSpec extends Specification {
    ...
    def "It should throw an exception because there are duplicated rooms within the given booking"(){
        ...
        and : "do the rooms support total guests amount process should not be called"
        0 * doTheRoomsSupportTotalGuestsAmountUseCase.execute(booking) >> {
            true
        }
        ...
        e.message == "It is not allow to book twice for the same room"
    }
